...
//
//    /* ---------------- BASIC UI ---------------- */
//    private TextInputLayout tilName, tilMobile, tilPassword, tilConfirmPassword;
//    private TextInputEditText etName, etMobile, etPassword, etConfirmPassword;
...
//
//        btnSendOtp.setVisibility(View.GONE); // 🔒 HIDE AFTER CLICK
//        resendOtpBtn.setVisibility(View.VISIBLE); // 🔥 ADD THIS
//
...
//                            if (resendTimer != null) {        // 🔥 ADD
//                                resendTimer.cancel();
//                                resendTimer = null;
//                            }
//
//                            btnSendOtp.setVisibility(View.GONE); // 🔒 FINAL HIDE
//                            otpView.setVisibility(View.GONE);
//
